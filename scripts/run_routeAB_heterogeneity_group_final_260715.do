...
esttab low_acc_rating high_acc_rating using "heterogeneity_acc_rating.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean) ///
...
capture drop het_med_re_rating
capture drop het_high_re_rating
bysort City ym: egen double het_med_re_rating = median(recent_rating_10) if het_base_cc
gen byte het_high_re_rating = (recent_rating_10 > het_med_re_rating) if het_base_cc

reghdfe ln_RevPAR_clean_w595 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199 ///
    if recent_rating_10 < het_med_re_rating, absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store low_re_rating
...
reghdfe ln_RevPAR_clean_w595 sim_mean ///
    ...
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199 ///
    if recent_rating_10 > het_med_re_rating, absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store high_re_rating


bdiff, group(het_high_re_rating) ///
...
esttab low_re_rating high_re_rating using "heterogeneity_re_rating.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean) ///
...
************************************************************
* 7-1. Comp: City ym ln_avg_com_RevPAR
************************************************************

capture drop het_med_com_RevPAR
capture drop het_high_com_RevPAR
bysort City ym: egen double het_med_com_RevPAR = median(ln_avg_com_RevPAR) if het_base_cc
gen byte het_high_com_RevPAR = (ln_avg_com_RevPAR >= het_med_com_RevPAR) if het_base_cc


reghdfe ln_RevPAR_clean_w195 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595 ///
    if ln_avg_com_RevPAR < het_med_com_RevPAR, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store low_com_RevPAR
...
reghdfe ln_RevPAR_clean_w195 sim_mean ///
    ...
    if ln_avg_com_RevPAR >= het_med_com_RevPAR, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store high_com_RevPAR

bdiff, group(het_high_com_RevPAR) ///
...
esttab low_com_RevPAR high_com_RevPAR using "heterogeneity_com_RevPAR.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
...
************************************************************
* 7-2. Comp: Zip ym ln_avg_com_RevPAR
************************************************************
	
capture drop het_med_com_RevPAR_zip
capture drop het_high_com_RevPAR_zip
bysort Zip ym: egen double het_med_com_RevPAR_zip = median(ln_avg_com_RevPAR) if het_base_cc
gen byte het_high_com_RevPAR_zip = (ln_avg_com_RevPAR >= het_med_com_RevPAR_zip) if het_base_cc
...
reghdfe ln_RevPAR_clean sim_mean ///
    ...
    if ln_avg_com_RevPAR < het_med_com_RevPAR, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store low_com_RevPAR_zip
...
reghdfe ln_RevPAR_clean sim_mean ///
    ...
    if ln_avg_com_RevPAR >= het_med_com_RevPAR, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store high_com_RevPAR_zip
...
esttab low_com_RevPAR_zip high_com_RevPAR_zip using "heterogeneity_com_RevPAR_zip.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595) ///
...
************************************************************
* 8-1. Revenue Relative city positioning gap
************************************************************

capture drop sim_mean_c gap_city_full_c
capture drop m8_city_miss m8_city_cc
capture drop het_med_city_gap_ym
capture drop hi_city_gap_focus100

* Center ARS at the focus100 sample mean.
...
* Center city positioning gap at the focus100 sample mean.
quietly summarize gap_city_mean_full ///
    if cs_sample_focus100 == 1 & !missing(gap_city_mean_full)
gen double gap_city_full_c = gap_city_mean_full - r(mean) ///
    if !missing(gap_city_mean_full)

* Construct the exact complete-case sample for M8.
egen byte m8_city_miss = rowmiss(ln_RevPAR_clean_w595 sim_mean ///
    gap_city_mean_full ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
    ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
    ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595)
gen byte m8_city_cc = (cs_sample_focus100 == 1 & m8_city_miss == 0)

* Median cutoff within City × month for grouped city-gap regressions.
bysort City ym: egen double het_med_city_gap_ym = ///
    median(gap_city_mean_full) if m8_city_cc == 1

gen byte hi_city_gap_focus100 = ///
    (gap_city_mean_full > het_med_city_gap_ym) ///
    if m8_city_cc == 1 & !missing(het_med_city_gap_ym)

reghdfe ln_RevPAR_clean_w199 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595 ///
    if hi_city_gap_focus100 == 0, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_city_gap_low

reghdfe ln_RevPAR_clean_w199 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595 ///
    if hi_city_gap_focus100 == 1, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_city_gap_high

bdiff, group(hi_city_gap_focus100) ///
    model(reghdfe ln_RevPAR_clean_w199 sim_mean ///
        recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
        lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595, ///
        absorb(hotel_id_num ym) cluster(hotel_id_num)) ///
...
esttab grp_city_gap_low grp_city_gap_high using "heterogeneity_city_revenuegap.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595) ///
...
************************************************************
* 8-2. Revenue Relative ZIP positioning gap
************************************************************

capture drop sim_mean_c gap_zip_full_c
capture drop m8_zip_miss m8_zip_cc
capture drop het_med_zip_gap_ym
capture drop hi_zip_gap_focus100


* Center ZIP positioning gap at the focus100 sample mean.
quietly summarize gap_zip_mean_full ///
    if cs_sample_focus100 == 1 & !missing(gap_zip_mean_full)
gen double gap_zip_full_c = gap_zip_mean_full - r(mean) ///
    if !missing(gap_zip_mean_full)

* Construct the exact complete-case sample for 8-2.
egen byte m8_zip_miss = rowmiss(ln_RevPAR_clean_w199 sim_mean ///
    gap_zip_mean_full ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
    ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
    ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199)
gen byte m8_zip_cc = (cs_sample_focus100 == 1 & m8_zip_miss == 0)

* Median cutoff within ZIP × month for grouped ZIP-gap regressions.
bysort Zip ym: egen double het_med_zip_gap_ym = ///
    median(gap_zip_mean_full) if m8_zip_cc == 1

gen byte hi_zip_gap_focus100 = ///
    (gap_zip_mean_full > het_med_zip_gap_ym) ///
    if m8_zip_cc == 1 & !missing(het_med_zip_gap_ym)

reghdfe ln_RevPAR_clean sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595 ///
    if hi_zip_gap_focus100 == 0, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_zip_gap_low

reghdfe ln_RevPAR_clean sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595 ///
    if hi_zip_gap_focus100 == 1, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_zip_gap_high

bdiff, group(hi_zip_gap_focus100) ///
    model(reghdfe ln_RevPAR_clean sim_mean ///
        recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
        lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595, ///
        absorb(hotel_id_num ym) cluster(hotel_id_num)) ///
...
esttab grp_zip_gap_low grp_zip_gap_high using "heterogeneity_zip_revenuegap.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean_w595) ///
...
************************************************************
* 9-1. City ym Price-position gap relative to local market
************************************************************

capture drop het_med_price_gap_cityym
capture drop het_high_price_gap_cityym

bysort City ym: egen double het_med_price_gap_cityym = median(price_gap) if het_base_cc
gen byte het_high_price_gap_cityym = (price_gap > het_med_price_gap_cityym) if het_base_cc

reghdfe ln_RevPAR_clean_w199 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199 ///
    if price_gap < het_med_price_gap_cityym, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_price_gap_low
...
reghdfe ln_RevPAR_clean_w199 sim_mean ///
    ...
    if price_gap > het_med_price_gap_cityym, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_price_gap_high

bdiff, group(het_high_price_gap_cityym) ///
    model(reghdfe ln_RevPAR_clean_w199 sim_mean ///
        recent_sd_10 ln_recent_volumn_10 recent_rating_10 ///
		ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc /// 
		ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199, ///
...
esttab grp_price_gap_low grp_price_gap_high using "heterogeneity_city_price_gap.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199) ///
...
************************************************************
* 9-2. Zip ym Price-position gap relative to local market
************************************************************

capture drop het_med_price_gap_zipym
capture drop het_high_price_gap_zipym

bysort Zip ym: egen double het_med_price_gap_zipym = median(price_gap) if het_base_cc
gen byte het_high_price_gap_zipym = (price_gap >= het_med_price_gap_zipym) if het_base_cc

reghdfe ln_RevPAR_clean_w199 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc ///
    lag_avg_rating_acc lag_sd_acc ln_avg_com_RevPAR ln_lag_RevPAR_clean ///
    if price_gap < het_med_price_gap_zipym, ///
    absorb(hotel_id_num ym) vce(cluster hotel_id_num)
estimates store grp_price_gap_low
...
bdiff, group(het_high_price_gap_zipym) ///
    model(reghdfe ln_RevPAR_clean_w199 sim_mean ///
        recent_sd_10 ln_recent_volumn_10 recent_rating_10 ///
		ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc /// 
		ln_avg_com_RevPAR ln_lag_RevPAR_clean, ///
...
esttab grp_price_gap_low grp_price_gap_high using "heterogeneity_zip_price_gap.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean) ///
...
esttab low_amenity_count high_amenity_count using "heterogeneity_amenity_count.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean) ///
...
bysort Zip ym: egen double het_med_amenity_count = median(het_amenity_count) if het_base_cc
gen het_high_amenity_count = .
replace het_high_amenity_count = 0 if het_amenity_count <= het_med_amenity_count
replace het_high_amenity_count = 1 if het_amenity_count > het_med_amenity_count
...
esttab low_amenity_count high_amenity_count using "heterogeneity_amenity_count_zip.rtf", replace rtf ///
    order(sim_mean ///
        ln_recent_volumn_10 recent_sd_10 recent_rating_10 ///
        ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
        ln_avg_com_RevPAR ln_lag_RevPAR_clean) ///
...
************************************************************
* 12. Experience/design-oriented vs functional/value-oriented hotel style
************************************************************
...
reghdfe ln_RevPAR_clean_w195 sim_mean ///
    recent_sd_10 ln_recent_volumn_10 recent_rating_10 ln_lag_volumn_acc lag_avg_rating_acc lag_sd_acc ///
    ln_avg_com_RevPAR ln_lag_RevPAR_clean_w199 ///
