...
log using "`project'/outputs/results_gmm_pre2019_same_sample_260407.log", text replace
...
export delimited using "`project'/outputs/gmm_pre2019_same_sample_scan_260407.csv", replace
export delimited using "`project'/outputs/gmm_pre2019_control_scan_260407.csv", replace
list ctrl timefe dyn siminst transform ylag xlag beta p ar1 ar2 han inst N pass nearpass in 1/20, clean noobs

preserve
keep in 1/20
export delimited using "`project'/outputs/results_gmm_pre2019_same_sample.txt", replace
restore
